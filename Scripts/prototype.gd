...
@onready var button: TextureButton = $Canvas/UI/Button
@onready var texture_progress_bar: TextureProgressBar = %TextureProgressBar
#@onready var phone_minigame: Area2D = $Minigames/Phone_minigame
#@onready var dialog: Control = $Canvas/Dialog
...
@onready var light_bulb: PointLight2D = $Objects/LightBulb

var _count := 0

#minigames
var monitor_instance: Node = null
var monitor_scene_ins: PackedScene = preload("res://Prefabs/monitor.tscn")
...
func _process(delta: float) -> void:
	...
	button.disabled = MiniGameManager.any_active() #there are minigames running = disabled
